<template>
  <form
    :class="{'bg-grey-lightest pb-2 mx-auto shadow-md rounded-xl max-w-xs': true, 'successEnabled bg-secondary flex justify-center': showSuccess}"
    action=""
  ...
  >
    ...
    <div
      ...
      class="reminder-sent-success modal-card text-white text-center font-semibold w-64 items-center flex px-4 py-12"
    >
      <img
    ...
    <div
      ...
      class="modal-card px-4 text-center items-center flex"
      style="width: auto;"
    >
      <button
        type="button"
