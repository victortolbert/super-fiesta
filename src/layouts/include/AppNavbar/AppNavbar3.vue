    ...
    <div id="nav" class="bg-blue-600 shadow">
      <div class="md:px-8">
        <nav class="relative flex flex-wrap items-center justify-between md:py-4">
          ...
          <div class="flex-shrink-0 pr-4 md:hidden">
            <button v-if="!isOpen" ref="openButton" v-on:click="open" type="button" class="block text-blue-100 focus:outline-none focus:text-white" aria-label="Menu">
            ...
            <button v-if="isOpen" ref="closeButton" v-on:click="close" type="button" class="block text-blue-100 focus:outline-none focus:text-white" aria-label="Close">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="hidden md:block md:ml-10 md:flex md:items-baseline md:justify-between md:bg-transparent">
            <div class="lg:absolute inset-0 flex items-center justify-center">
              <a href="#" class="text-sm font-medium text-blue-100 hover:text-blue-700">Products</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-blue-700">Marketplace</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-blue-700">Partners</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-blue-700">About</a>
            </div>
            <div class="ml-10 relative flex items-baseline">
              <a href="#" class="text-sm font-medium text-blue-100 hover:text-blue-700">Log in</a>
      ...
      <div class="md:hidden">
        ...
        <transition
          ...
          appear
        >
          <div v-show="isOpen" class="z-10 fixed inset-y-0 right-0 max-w-2xs w-full bg-white transition-transform overflow-hidden shadow-lg mt-16">
            <div class="relative z-10 bg-white">
              <div class="pb-6">
                ...
                <a href="#" class="block m-0 p-4 font-semibold text-blue-600 border-b border-gray-300 hover:text-blue-700 hover:bg-gray-100">Home</a>
                <a href="#" class="block m-0 p-4 font-medium text-gray-500 border-b border-gray-300 hover:text-blue-700 hover:bg-gray-100">Easy Emailer</a>
                <a href="#" class="block m-0 p-4 font-medium text-gray-500 border-b border-gray-300 hover:text-blue-700 hover:bg-gray-100">Finish Line</a>
                ...
                <a href="#" class="block m-0 p-4 font-medium text-gray-500 border-b border-gray-300 hover:text-blue-700 hover:bg-gray-100">Home</a>
                <a href="#" class="block m-0 p-4 font-medium text-gray-500 border-b border-gray-300 hover:text-blue-700 hover:bg-gray-100">Easy Emailer</a>
