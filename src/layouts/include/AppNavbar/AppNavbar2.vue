<template>
  <div class="" style="min-height: 640px;">
    <div id="nav" class="bg-blue-900 shadow">
      <div class="md:px-8">
        <nav class="relative flex flex-wrap items-center justify-between md:py-4">
          ...
          <div class="flex-shrink-0 pr-4 md:hidden">
            <button ref="openButton" v-on:click="open" type="button" class="block text-blue-100 focus:outline-none focus:text-white" aria-label="Menu">
          ...
          <div class="hidden md:block md:ml-10 md:flex md:items-baseline md:justify-between md:bg-transparent">
            <div class="lg:absolute inset-0 flex items-center justify-center">
              <a href="#" class="text-sm font-medium text-blue-100 hover:text-gray-700">Products</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-gray-700">Marketplace</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-gray-700">Partners</a>
              <a href="#" class="ml-10 text-sm font-medium text-blue-100 hover:text-gray-700">About</a>
            </div>
            <div class="ml-10 relative flex items-baseline">
              <a href="#" class="text-sm font-medium text-blue-100 hover:text-gray-700">Log in</a>
          ...
          <div v-show="isOpen" class="z-10 fixed inset-y-0 right-0 max-w-xs w-full bg-white transition-transform overflow-y-auto">
            <div class="relative z-10 bg-white">
              ...
              <div class="pb-6">
                ...
                <div class="px-4">
                  <a href="#" class="mt-8 block text-xs font-semibold text-gray-600 uppercase tracking-wider">Components</a>
                  <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Layout</a>
                  <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Base</a>
                  <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Patterns</a>
                  <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Views</a>
                </div>
